...
@section('content')
    <!-- Modal Edit -->
    <form method="post" action="<?= url('app-admin/data/traveltopia/kategori/proses-ubah') ?>">
        @csrf
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                ...
                <form method="POST" action="{{ url('app-admin/data/traveltopia/kategori/proses-tambah') }}">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            @foreach ($category_news as $category)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ url('app-admin/data/traveltopia/kategori/proses-hapus/' . $category->id) }}"
    ...
    <script type="text/javascript">
        function edit(id, name, name_en, name_mandarin) {
            $("#editCategoryId").val(id)
            $("#editCategoryName").val(name)
            $("#editCategoryNameEn").val(name_en)
            $("#editCategoryNameMandarin").val(name_mandarin)
        }
    </script>
@endsection
