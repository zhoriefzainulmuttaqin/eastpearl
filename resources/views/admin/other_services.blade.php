...
@section('content')
    <div class="mb-3 text-right">
        <a href='{{ url('/app-admin/data/tambah/other_services') }}'>
                        ...
                        <tbody>
                            @foreach ($other as $lainnya)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href='{{ url("/app-admin/data/other_services/ubah/$lainnya->slug") }}'>
                                            <button type="button" class="btn btn-sm btn-success" title="Ubah">
                                                <i class="fas fa-edit"></i></button>
                                        </a>
                                        <a href="{{ url("/app-admin/data/other_services/hapus/$lainnya->id") }}"
                                            onclick='return confirm("Apakah anda yakin hapus {{ $lainnya->name }}?")'>
