...
@section('content')
    <div class="mb-3 text-right">
        <a href='{{ url('/app-admin/data/tambah/kategori_galeri') }}'>
            ...
            <div class="card">
                <div class="card-body">
                    <table class="table table-bordered" id="datatable">
                        ...
                        <tbody>
                            @foreach ($kategori_galeri as $ktg)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href='{{ url("/app-admin/data/kategori_galeri/ubah/$ktg->slug") }}'>
                                            <button type="button" class="btn btn-sm btn-success" title="Ubah">
                                                <i class="fas fa-edit"></i></button>
                                        </a>
                                        <a href="{{ url("/app-admin/data/kategori_galeri/hapus/$ktg->id") }}"
