        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Ubah Souvenir</h3>
                </div>
                <form method="POST" action="{{ url('app-admin/data/souvenir/proses-ubah') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                id="name" placeholder="Masukan Nama Souvenir "
                                value="{{ old('name') ?? $souvenir->name }}" required autocomplete="off">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name_en') is-invalid @enderror" name="name_en"
                                ...
                                value="{{ old('name_en') ?? $souvenir->name_en }}" required autocomplete="off">
                            @error('name_en')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name_mandarin') is-invalid @enderror"
                                ...
                                placeholder="Masukan Nama Souvenir (Bahasa Mandarin) "
                                value="{{ old('name_en') ?? $souvenir->name_mandarin }}" required autocomplete="off">
                            @error('name_mandarin')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug"
                                value="{{ old('slug') ?? $souvenir->slug }}" type="text" required
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="souvenir_category_id" required name="souvenir_category_id">
                                ...
                                @foreach ($categories as $category)
                                    <?php
                                    if ($souvenir->souvenir_category_id == $category->id) {
                                        $selected = 'selected';
                                    } else {
                                        $selected = '';
                                    }
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('price') is-invalid @enderror" name="price"
                                id="price" placeholder="Masukan Harga " value="{{ old('price') ?? $souvenir->price }}"
                                autocomplete="off">
                            @error('price')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('disc_price') is-invalid @enderror"
                                ...
                                value="{{ old('disc_price') ?? $souvenir->disc_price }}" autocomplete="off">
                            @error('disc_price')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('desc') is-invalid @enderror" name="desc" id="desc"
                                placeholder="Masukan Deskripsi " required autocomplete="off" required>{{ old('desc') ?? $souvenir->desc }}</textarea>
                            @error('desc')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('desc_en') is-invalid @enderror" name="desc_en" id="desc_en"
                                placeholder="Masukan Deskripsi (Bahasa Inggris) " required autocomplete="off" required>{{ old('desc_en') ?? $souvenir->desc_en }}</textarea>
                            @error('desc_en')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('desc_mandarin') is-invalid @enderror" name="desc_mandarin" id="desc_mandarin"
                                placeholder="Masukan Deskripsi (Bahasa Mandarin) " required autocomplete="off" required>{{ old('desc_mandarin') ?? $souvenir->desc_mandarin }}</textarea>
                            @error('desc_mandarin')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <img id="addImage" src='{{ url("/assets/souvenir/$souvenir->image") }}'
                        ...
                        <div class="form-group">
                            ...
                            <input name="link_shopee" class="form-control @error('link_shopee') is-invalid @enderror"
                                id="link_shopee" value="{{ old('link_shopee') ?? $souvenir->link_shopee }}"
                        ...
                        <div class="form-group">
                            ...
                            <input name="link_amazon" class="form-control @error('link_amazon') is-invalid @enderror"
                                id="link_amazon" value="{{ old('link_amazon') ?? $souvenir->link_amazon }}"
                        ...
                        <div class="form-group">
                            ...
                            <input name="link_alibaba" class="form-control @error('link_alibaba') is-invalid @enderror"
                                id="link_alibaba" value="{{ old('link_alibaba') ?? $souvenir->link_alibaba }}"
                                type="url" placeholder="https://...">
                            @error('link_alibaba')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input name="link_tokopedia"
                                ...
                                value="{{ old('link_tokopedia') ?? $souvenir->link_tokopedia }}" type="url"
                                placeholder="https://...">
                        ...
                        <div class="form-group">
                            ...
                            <input name="link_blibli" class="form-control @error('link_blibli') is-invalid @enderror"
                                id="link_blibli" value="{{ old('link_blibli') ?? $souvenir->link_blibli }}"
                                type="url" placeholder="https://...">
                            @error('link_blibli')
                                <div class="invalid-feedback">
                                    {{ $message }}
