...
@section('content')
    ...
    <div class="container-lg mt-5">
        <h1
            ...
            @if ($category->name == 'Massage & Reflexology')
                @if (App::isLocale('id'))
                    Setelah trip, enaknya merefleksikan tubuh dengan pijatan dari <span style="color: #ba1918"> FIT Massage &
                        Reflexology.
                    </span>
                @elseif(App::isLocale('en'))
                    After the trip, it's perfect to rejuvenate your body with a massage from <span style="color: #ba1918">
                        FIT Massage & Reflexology. </span>
                @else
                    旅行后，最适合用东珠的按摩来放松身体。
                @endif
            @else
        ...
        @if ($category->name == 'Massage & Reflexology')
            <div class="d-flex flex-col">
                <div>
                    @if (App::isLocale('id'))
                        <img src="{{ url('/assets/services/poster_fit.png') }}" alt="FIT Massage & Reflexology Brochure"
                            style="width: 100%; height: auto;" />
                    @elseif(App::isLocale('en'))
                        <img src="{{ url('/assets/services/poster_fit_en.png') }}" alt="FIT Massage & Reflexology Brochure"
                            style="width: 100%; height: auto;" />
                    @else
                        <img src="{{ url('/assets/services/poster_fit_en.png') }}" alt="FIT Massage & Reflexology Brochure"
                            style="width: 100%; height: auto;" />
                ...
                <div class="flex mt-4 justify-content-center">
                    <div class="relative flex flex-col mb-4 rounded-xl bg-success bg-clip-border text-gray-700 shadow-lg">
                        @if (App::isLocale('id'))
                            <a href="{{ url('https://wa.link/h6yeem') }}" class="btn text-white " id="but_wisata"
                                target="_blank">
                                <i class="uil uil-whatsapp"></i> {{ __('detail_layanan.book_wa') }}
                            </a>
                        @elseif(App::isLocale('en'))
                            <a href="{{ url('https://wa.link/swxpjr') }}" class="btn text-white " id="but_wisata"
                                target="_blank">
                                <i class="uil uil-whatsapp"></i> {{ __('detail_layanan.book_wa') }}
                            </a>
                        @else
